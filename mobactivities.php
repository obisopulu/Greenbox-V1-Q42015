...
echo"<table align='center' width='100%'><tr><td align='left'><span style='color:#1F7044; font-size:50px'>Activities</td></tr></table>";
...
<tr height='10px'>
	<td style='padding:10px; width:auto; background-color:#DDD;'>
...
echo"<span style='color:#EEE;'>";echo $activityMonth; echo"</b></span></div>
	...
	<td colspan='2' padding:25px 50px 75px 0px;  background-color:#EEE; float:left;'>";
	if ($activityPic != '')
		{
			echo "<img src='activitiesimg/$activityPic' width='250px' style='float:left; margin:0px 10px 10px 0px;' height='250px'/>";
		}
echo"</td></tr><tr><td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$activityInfo
</td></tr>
