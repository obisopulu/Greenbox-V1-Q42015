...
<meta name="description" content="Nigerian Music Archive" />
...
?>green, greenbox, green box, naija, 9ja
" />
...
<form action="mobinfo.php" method="post">
<input type='submit' name='' value='' style='background:url(img/info.png) #EEEEEE center no-repeat; border:none; height:80px; width:80px; cursor:pointer;'/></form>
</td>
</tr></table>
...
echo"</td></tr><tr><td align='right'><b><a href='mobmusic.php' style='display:compact;'><span style='color:#1f7044;'><b>The Music</b></span></a></b></td></tr></table>
...
echo"</td></tr><tr><td align='right'><b><a href='mobpeople.php' style='display:compact;'><span style='color:#1f7044;'><b>The People</b></span></a></b></td></tr></table>
...
echo"</td></tr><tr><td align='right'><b><a href='moblabels.php' style='display:compact;'><span style='color:#1f7044;'><b>The Labels</b></span></a></b></td></tr></table>
...
while($row=mysql_fetch_assoc($result3))
	...
	{extract($row);
		...
		echo "<table align='center' width='100%' height='700px'style=' background:url("; if ($activityPic=='') {echo "img/gb.png";}else{echo"activitiesimg/$activityPic";}echo ") no-repeat; background-size:cover; -webkit-filter: grayscale(100%); margin:1px; color:#DDD'>
		<tr><td align='left' style='text-shadow:1px 1px 1px #000'>
		<h1>";
		echo $activityDay;
		echo"<span style='color:#FFF;'>{$row['activityMonth']}</span><br/></h1><b><span style='color:#1f7044;'>{$row['activityName']}</span></b>
		</td><td align='left'  style='text-shadow:1px 1px 1px #000'><span>"; echo substr_replace($activityInfo,'...',80); echo "<br/><a href='Activities.php#{$row['activityDay']}{$row['activityMonth']}{$row['activityYear']}' style='display:compact; color:#1f7044;'>more</span></a></td></tr></table>";
	}
echo"</td></tr><tr><td align='right'><b><a href='mobactivities.php' style='display:compact;'><span style='color:#1f7044;'><b>The Activities</b></span></a></b></td></tr></table>";
mysql_close($cxn);
