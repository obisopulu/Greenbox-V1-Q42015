...
$sql2 = mysql_query("SELECT * FROM labels ORDER BY labelID DESC $limit");
...
echo"<table align='center' bgcolor='#444'>
	<tr  bgcolor='#555' height='11px'>
    	...
    	<td width='15px' style='padding:5px 5p;'>label<br/>ID</td>
        <td width='' style='padding:5px 5p;'>labelName</td>
        <td width='auto' style='padding:5px 5p;'>label<br/>Pic</td>
        <td style='padding:5px 5p;'>labelOwner</td>
        <td style='padding:5px 5p;'>labelIntro</td>
        <td style='padding:5px 5p;'>labelHistory</td>
        <td style='padding:5px 5p;'>labelArtists</td>
        <td style='padding:5px 5p;'>labelProducers</td>
...
while($row = mysql_fetch_array($sql2))
	{extract($row);
    	...
    	<td style="padding:0px 5px;"><?php echo trim($labelID)?></td>
        <td style="padding:0px 5px;"><?php echo trim($labelName)?></td>
        <td style="padding:0px 5px;"><?php if (trim($labelPic) != '') echo 'Yes';else echo 'No'?></td>
        <td style="padding:0px 5px;"><?php echo trim($labelOwner)?></td>
        <td style="padding:0px 5px;"><?php echo trim($labelIntro)?></td>
        <td style="padding:0px 5px;"><?php echo trim($labelHistory)?></td>
        <td style="padding:0px 5px;"><?php echo trim($labelArtists)?></td>
        <td style="padding:0px 5px;"><?php echo trim($labelProducers)?></td>
