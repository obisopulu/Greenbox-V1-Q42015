...
echo"<table align='center' bgcolor='#444'>
	<tr  bgcolor='#555' height='11px'>
    	...
    	<td width='15px' style='padding:5px 5p;'>activityID<br/>ID</td>
        <td width='' style='padding:5px 5p;'>activityName</td>
        <td width='auto' style='padding:5px 5p;'>activity<br/>Pic</td>
        <td style='padding:5px 5p;'>activityInfo</td>
        <td style='padding:5px 5p;'>activityDay</td>
        <td style='padding:5px 5p;'>activityMonth</td>
        <td style='padding:5px 5p;'>activityYear</td>
        <td style='padding:5px 5p;'>activityDate</td>
...
while($row = mysql_fetch_array($sql2))
	{extract($row);
    	...
    	<td style="padding:0px 5px;"><?php echo trim($activityID)?></td>
        <td style="padding:0px 5px;"><?php echo trim($activityName)?></td>
        <td style="padding:0px 5px;"><?php if (trim($activityPic) != '') echo 'Yes';else echo 'No'?></td>
        <td style="padding:0px 5px;"><?php echo trim($activityInfo)?></td>
        <td style="padding:0px 5px;"><?php echo trim($activityDay)?></td>
        <td style="padding:0px 5px;"><?php echo trim($activityMonth)?></td>
        <td style="padding:0px 5px;"><?php echo trim($activityYear)?></td>
