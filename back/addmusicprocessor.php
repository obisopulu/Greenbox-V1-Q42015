...
<link href="../back/back.css" rel="stylesheet" type="text/css" />
...
<tr>
	<td align="left" width="25%">
		 <a href="../index.php"><<  Go Frontyard  <<</a><br/><a href="../back/backyard.php"><<  Go Dashboard  <<</a>
	</td>
...
VALUES ('' , '{$_POST['songTitle']}' , '{$_POST['songArtist']}' , '{$_POST['songArtistFt']}' ,
 '{$_POST['songAlbum']}' , '$artFile' ,  '{$_POST['songProducer']}' , '{$_POST['songBeatmaker']}' ,  '{$_POST['songLenght']}' , '$songType' , '$songSize' , '$musicFile' ,  '{$_POST['songGenre']}' , '{$_POST['songYear']}' ,  '{$_POST['songLanguage']}' , '{$_POST['songRating']}', '' ,'$month','$day','$year','$f_today')";
...
echo"<form action='addmusicprocessor.php' enctype='multipart/form-data' method='post'>
	...
	<td style='padding:5px; font-size:12px; font-weight:bold'>SongTitle(50)<br/>
		...
		<div  style='float:left;'><input size='10' type='text' name='songProducer' maxlength='50' value='' style='color:#444; background-color:#CCC; border:none; padding:5px'></div>
