...
$sql = mysql_query("SELECT * FROM feedback ORDER BY feedID ASC");
...
$sql2 = mysql_query("SELECT * FROM feedback ORDER BY feedID DESC $limit");
...
echo"<table align='center' bgcolor='#444'>
	<tr  bgcolor='#555' height='11px'>
    	...
    	<td width='15px' style='padding:5px 5p;'>ID<br/>ID</td>
        <td width='' style='padding:5px 5p;'>feed Name</td>
        <td style='padding:5px 5p;'>feed Subject</td>
        <td style='padding:5px 5p;'>feed details</td>
		<td style='padding:5px 5p;'>Date<br/>Recieved</td>
        </tr>";
$r = 1;
while($row = mysql_fetch_array($sql2))
	{extract($row);
    	...
    	<td style="padding:0px 5px;"><?php echo trim($feedID)?></td>
        <td style="padding:0px 5px;"><?php echo trim($feedName)?></td>
        <td style="padding:0px 5px;"><?php echo trim($feedTopic)?></td>
        <td style="padding:0px 5px;"><?php echo trim($feedBack)?></td>
        <td style="padding:0px 5px;"><?php echo trim($feedDate)?></td>
        </tr>
        <?php $r++; } ?>
        </table>
